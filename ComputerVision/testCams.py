...
def takeImages():
    ...
    while(vid.isOpened()):
        ...
        cv2.circle(framecopy,(230,130), radius=0, color=(0,0,255), thickness=5)
        cv2.circle(framecopy, (330,230), radius=0, color=(0,0,255), thickness=5)
        cv2.circle(framecopy, (430,330), radius=0, color=(0,0,255), thickness=5)
...
def findFaceColors():
    ...
    frontX = [230, 330, 430, 230, 330, 430, 230, 330, 430]
    frontY = [130, 130, 130, 230, 230, 230, 330, 330, 330]
...
def findCubieColor(avgColor):
    ...
    if 189 <= avgColor[0] <=250 and 35 <= avgColor[1] <= 97 and 35 <= avgColor[2] <= 100:
        print("blue")
        colors.append("blue")
        return 'L'
    elif (345 <= avgColor[0] or avgColor[0] <= 12) and 50 <= avgColor[1] <= 100 and 45 <= avgColor[2] <= 100:
        print("red")
        colors.append("red")
        return 'F'
