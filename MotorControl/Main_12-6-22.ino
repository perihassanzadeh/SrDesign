...
String moves[80];  //String *moves; //all moves read from serial
int movesLength = 0;
  ...
  switch(stateLoop)
  {
    ...
    case Shuffle://**/////////////////////////////////////////////////////////////////////////////////////////**
      ...
      if(B2Flag){ //button to start shuffling
        ...
        memset(moves, "", sizeof(moves));   //delete [] moves; //clear moves
        state = Home;
        B2Flag = 0;
      }
    ...
    case Scan://**/////////////////////////////////////////////////////////////////////////////////////////**
      ...
      if(B2Flag){ //button to start scan
        ...
        Serial.flush();
        while(!Serial.available()) {}    //wait here until serial data is available
    ...
    case Solve://**/////////////////////////////////////////////////////////////////////////////////////////**
      ...
      /*
        ...
        if(B2Flag){ //button to start solve, run motor sequence
          ...
          inputSequence = "";     //memset(inputSequence, "", sizeof(inputSequence));  //clear input string and move array
          memset(moves, "", sizeof(moves));  //delete [] moves;
